...
@SourceType(value = "PrestoARP", label = "Presto",uiConfig = "presto-layout.json")
public class PrestoConf extends AbstractArpConf<PrestoConf> {
  private static final String ARP_FILENAME = "arp/implementation/presto-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.presto.PrestoDriver";
